        ...
        "jobs": [
            {
                ...
                "id": "job-001",
                "input_artifacts": ["input/feature.md", "input/factory.yaml", "input/build-memory.md"],
                "lease_owner": None,
                "role": "planner",
                "status": "queued",
            },
            {
                ...
                "id": "job-002",
                "input_artifacts": ["input/feature.md", "plan.md", "input/factory.yaml", "input/build-memory.md"],
                "lease_owner": None,
                "role": "architect",
                "status": "queued",
            },
